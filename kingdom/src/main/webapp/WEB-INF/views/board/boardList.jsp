...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.w3-button').click(function(){
			...
			switch(tid){
			case 'hbtn':
				url = '/kingdom/main.cnu';
				break;
			case 'lbtn':
				url = '/kingdom/member/login.cnu';
				break;
			case 'jbtn':
				url = '/kingdom/member/join.cnu';
				break;
			case 'wbtn':
				url = '/kingdom/board/boardWrite.cnu';
				break;
			case 'outbtn':
				url = '/kingdom/member/logout.cnu';
				break;
			}
		...
		$('.list').click(function(){
			...
			// 폼태그가 전송될 주소를 셋팅하고
			$('#frm').attr('action', '/kingdom/board/boardDetail.cnu');
...
<body>
	<form method="POST" action="/kingdom/board/boardList.cls"  id="frm" name="frm">
